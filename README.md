...
Installer automatically generates a customizable “install” button that can be used in any web app, and will only display on supporting browsers if the app has not already been installed.
